...
#define NUM_INODE_BLOCKS (MAX_INUM*256) / 4096
#define NUM_INODES_PER_BLOCK 4096 / 256
#define NUM_SUPER_BLOCKS 1
#define NUM_BITMAP_BLOCKS 2
#define TOTAL_BLOCKS (32*1024*1024) / 4096
#define NUM_DATA_BLOCKS TOTAL_BLOCKS - (NUM_INODE_BLOCKS + NUM_SUPER_BLOCKS + NUM_BITMAP_BLOCKS)
#define DIRTYPE 1
#define FILETYPE 2
#define MAX_BLOCKS_PER_INODE 16+8*(BLOCK_SIZE/sizeof(int))
